...
Subsubcate SubsubcateFromJson(String str) =>
    Subsubcate.fromJson(json.decode(str));

String SubsubcateToJson(Subsubcate data) => json.encode(data.toJson());
...
class Subsubcate {
  ...
  Subsubcate.fromJson(dynamic json) {
    _result = json['result'];
