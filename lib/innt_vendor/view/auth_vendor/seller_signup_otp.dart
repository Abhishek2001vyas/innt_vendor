...
import '../Api/seller_signup_verify_api.dart';

var one;

class SellerSignUpOTP extends StatefulWidget {
  final otp;
  final mobile;

  const SellerSignUpOTP({required this.otp, required this.mobile});

  @override
  State<SellerSignUpOTP> createState() => _SellerSignUpOTPState();
}

class _SellerSignUpOTPState extends State<SellerSignUpOTP> {
                ...
                children: [
                  ...
                  !_isTimerActive
                      ? GestureDetector(
                          onTap: () async {
                            resendOTP();
                            await Verifyapi.resend_otpmobile(widget.mobile);
                          },
                          child: Center(
                            child: Text(
                              'Resend code',
