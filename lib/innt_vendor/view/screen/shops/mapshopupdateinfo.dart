...
class MapScreen2 extends StatefulWidget {
  ...
  const MapScreen2({super.key, required this.lat, required this.lon});
  ...
  void showBottomSheet() async {
    if (showLocation != null) {
      ...
      if (placemarks.isNotEmpty) {
        ...
        setState(() {
          lonnn2 = showLocation!.longitude;
          lattt2 = showLocation!.latitude;
          // ${placemark.street},
          getprofilesller.address.value =
          ...
          saveAddressToSharedPreferences(
              getprofilesller.address.value); // Save the address
        });
      }
      // final GoogleMapController controller = await _controller.future;
