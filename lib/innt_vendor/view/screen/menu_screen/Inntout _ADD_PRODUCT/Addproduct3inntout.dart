...
class AddProductOtherinnout extends StatefulWidget {
  const AddProductOtherinnout({super.key});

  @override
  State<AddProductOtherinnout> createState() => _AddProductOtherinnoutState();
}

class _AddProductOtherinnoutState extends State<AddProductOtherinnout> {
