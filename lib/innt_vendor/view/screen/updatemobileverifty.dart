...
class SellerupdatemobileOTP extends StatefulWidget {
  final otp;
  final mobile;

  const SellerupdatemobileOTP({required this.otp, required this.mobile});

  @override
  State<SellerupdatemobileOTP> createState() => _SellerupdatemobileOTPState();
}

class _SellerupdatemobileOTPState extends State<SellerupdatemobileOTP> {
  ...
  Timer? _timerr;
  final Verifyapi = Get.put(fetchVendorProfile());
                    ...
                    : Padding(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: _isVerifyButtonEnabled
                                ? () async {
                                    Verifyapi.vendorPromoverfiy(widget.mobile,
