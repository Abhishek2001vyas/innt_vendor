...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key? key, this.userid, this.userimage, this.username, required this.status})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Stack(
        children: [
          StreamBuilder(
            stream: chat_api.uservenderchat(widget.userid,widget.status),
              ...
              return
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: chat_api.uservenderchatlist[0]["data"].length,
                    itemBuilder: (context, index) {
                      var findvideo1 = chat_api.uservenderchatlist.elementAt(
                          0)["data"][index]["text"]
                          .split('.')
                          .last
                          .toLowerCase();
                      ...
                      return
                        chat_api.uservenderchatlist.elementAt(
                        ...
                        VideoWithImagePlaceholder(
                          videoUrl: "$image_url${chat_api.uservenderchatlist
                        ...
                        BubbleNormalImage(
                          image: Image.network("$image_url${chat_api
                        ...
                        Padding(
                          ...
                          child: VengamoChatUI(
                              ...
                              time: getTime(),
                              isAudio: true,
                              audioSource: '$image_url${chat_api
                                  .uservenderchatlist.elementAt(
                                  0)["data"][index]["text"]}',
                        ...
                        chat_api.uservenderchatlist.elementAt(
                            0)["data"][index]["send_status"].toString() == "4" ?
                        BubbleNormal(
                          text: '${chat_api.uservenderchatlist.elementAt(
                              0)["data"][index]["text"].toString()}',
                          textStyle: TextStyle(
                            fontSize: 10,
                            color: Colors.white,
                        ...
                        chat_api.uservenderchatlist.elementAt(
                            0)["data"][index]["send_status"].toString() == "0" ?
                        BubbleNormal(
                          text: '${chat_api.uservenderchatlist.elementAt(
                              0)["data"][index]["text"].toString()}',
                          textStyle: TextStyle(
          ...
          MessageBar(
            onSend: (p0) async {
              await chat_api.chatsendlist(widget.userid, p0.toString(),widget.status);
              _scrollToBottom();
            },
            actions: [
              Row(
...
// Define the _playPauseButtonClick function
  ...
  Future cam() async {
    ...
    Get.to(Pickview(shopname: widget.username,
      shopid: widget.userid,status: widget.status,
...
class Pickview extends StatefulWidget {
  ...
  final int status;
  const Pickview(
      {super.key, this.shopname, this.shopid, required this.shopimage, required this.status,});
              ...
              children: [
                ...
                IconButton(onPressed: () async {
                  await chat_api.chatimageapi(
                      widget.shopid, chat_api.imagePath.value.toString(),
                      widget.shopname, widget.shopimage,widget.status);
