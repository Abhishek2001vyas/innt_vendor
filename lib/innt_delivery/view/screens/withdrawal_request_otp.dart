...
class WithdrawalRequestOtp extends StatefulWidget {
  final mobile;
  final otp;
  final amount;

  const WithdrawalRequestOtp({super.key, this.mobile, this.otp, this.amount});

  @override
  State<WithdrawalRequestOtp> createState() => _WithdrawalRequestOtpState();
}

class _WithdrawalRequestOtpState extends State<WithdrawalRequestOtp> {
  ...
  // final Verifyapi = Get.put(Seller_Verify_api());
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                    style: buttonPrimary,
                    onPressed: () async {
                      walletapi.withdrawalrequestverify(
                          widget.amount,
                          widget.mobile,
                          _otpController.text.toString(),
                          context);
                    },
                    child: Text("Verify", style: A_style_text_inside_button)),
              ),
