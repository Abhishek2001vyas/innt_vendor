...
class DeliveryForgotOtp extends StatefulWidget {
  final mobileno;
  final otp;

  const DeliveryForgotOtp({super.key, this.mobileno, this.otp});

  @override
  State<DeliveryForgotOtp> createState() => _DeliveryForgotOtpState();
}

class _DeliveryForgotOtpState extends State<DeliveryForgotOtp> {
  ...
  Timer? _timerr;
  final forgotVerifyapi = Get.put(Devilery_login_api());
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text('${widget.mobileno}', style: A_style_mid),
              ),
              SizedBox(
                height: h / 28,
              ),
                    ...
                    : Padding(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: _isVerifyButtonEnabled
                                ? () async {
                                    Map body = {
                                      'key': widget.mobileno.toString(),
                                      "otp": _otpController.text.toString()
                                    };
                                    await forgotVerifyapi.forgotverify(body);
                                  }
                                : null,
                            child: Text("Verify",
